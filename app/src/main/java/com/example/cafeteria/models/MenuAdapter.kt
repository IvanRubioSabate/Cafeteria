...
class MenuAdapter(private val mList: List<Food>, private val menuViewModel: MenuViewModel) : RecyclerView.Adapter<MenuAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.menu_adapter_view, parent, false)
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.deleteProductButton.setOnClickListener {
            menuViewModel.deleteProduct(position)
        }
    }
